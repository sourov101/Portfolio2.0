...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Md. Mahmudur Rahman Sourov
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">MARN Stack developer</h3>

            <p className="home__description"> I am a web developer focusing on front-end developing, react and MERN stack, and I am very passionate and dedicated to my work</p>
